...
school_of_rock = media.Movie("School of Rock",
                             "A guitarist plan to compete in a Battle of the Bands tournament",
...
ratatouille = media.Movie("Ratatouille",
                          "A ambitious young rat gifted with highly developed sense of taste and smell with a dream to become a cook",
...
hunger_games = media.Movie("Hunger Games",
                           "A dystopian nation with glamorous Capitol and twelve poorer disticts",
...
midnight_in_paris = media.Movie("Midnight in Paris",
                                "A screenwriter's desier for past era finds a transport past midnight",
